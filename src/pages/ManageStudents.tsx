...
function ManageStudents() {
  ...
  const [students, setStudents] = useState<Student[]>([
    { id: 1, name: 'John Doe', email: 'john@test.com', phone: '+1234567890', address: '123 Main St' },
    { id: 2, name: 'Jane Smith', email: 'jane@test.com', phone: '+1987654321', address: '456 Oak Ave' },
    { id: 3, name: 'Bob Johnson', email: 'bob@test.com', phone: '+1122334455', address: '789 Elm Rd' }
  ]);
